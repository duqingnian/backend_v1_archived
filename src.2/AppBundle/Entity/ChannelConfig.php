...
class ChannelConfig
{
     ...
     * @ORM\Column(type="string", length=35)
     */
    private $payin_qrcode_column = ""; //二维码的字段
	
	/**
     * @ORM\Column(type="string", length=35)
     */
    private $payin_jump_column = ""; //跳转地址的字段
	
	/**
     * @ORM\Column(type="string", length=35)
     */
    private $payin_notify_column = ""; //回调的字段
	
	/**
     * @ORM\Column(type="string", length=35)
     */
    private $shanghu_orderno_column = ""; //三方返回的平台的订单号
    ...
    /**
     * Set payinQrcodeColumn
     *
     * @param string $payinQrcodeColumn
     *
     * @return ChannelConfig
     */
    public function setPayinQrcodeColumn($payinQrcodeColumn)
    {
        $this->payin_qrcode_column = $payinQrcodeColumn;

        return $this;
    }

    /**
     * Get payinQrcodeColumn
     *
     * @return string
     */
    public function getPayinQrcodeColumn()
    {
        return $this->payin_qrcode_column;
    }

    /**
     * Set payinJumpColumn
     *
     * @param string $payinJumpColumn
     *
     * @return ChannelConfig
     */
    public function setPayinJumpColumn($payinJumpColumn)
    {
        $this->payin_jump_column = $payinJumpColumn;
     ...
     * @return string
     */
    public function getPayinJumpColumn()
    {
        return $this->payin_jump_column;
    }

    /**
     * Set payinNotifyColumn
     *
     * @param string $payinNotifyColumn
     *
     * @return ChannelConfig
     */
    public function setPayinNotifyColumn($payinNotifyColumn)
    {
        $this->payin_notify_column = $payinNotifyColumn;

        return $this;
    }

    /**
     * Get payinNotifyColumn
     *
     * @return string
     */
    public function getPayinNotifyColumn()
    {
        return $this->payin_notify_column;
    }

    /**
     * Set shanghuOrdernoColumn
     *
     * @param string $shanghuOrdernoColumn
     *
     * @return ChannelConfig
     */
    public function setShanghuOrdernoColumn($shanghuOrdernoColumn)
    {
        $this->shanghu_orderno_column = $shanghuOrdernoColumn;

        return $this;
    }

    /**
     * Get shanghuOrdernoColumn
     *
     * @return string
     */
    public function getShanghuOrdernoColumn()
    {
        return $this->shanghu_orderno_column;
    }
}
